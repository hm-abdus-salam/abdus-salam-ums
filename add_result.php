...
<div class="all_student fix">
		...
		//SELECT avg(marks) as sgpa from result where st_id=10 and semester="1st"
		?>
	<div>
				...
				<table>
					<tr>
						...
						<select name="subject" id="">
							...
							<option value="Microprocessors & Assemblu Language">Microprocessors & Assemblu Language</option>
